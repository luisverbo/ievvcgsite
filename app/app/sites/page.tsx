...
/*
 * O construtor por blocos — FERRAMENTA INTERNA, só sua.
 *
 * Era a home do painel quando o produto era outro. Hoje o produto vendido é o
 * construtor com IA; este aqui continua existindo para o seu uso, mas cliente
 * não vê: nem o link, nem a rota (o notFound abaixo segura quem digitar a URL).
 */
...
export default async function SitesBlocosPage() {
    ...
    <div className="painel-wrap flex flex-col gap-8">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          ...
          <h1 className="mt-2 text-2xl font-extrabold">Sites por blocos 🧱</h1>
          <p className="mt-1 text-sm text-paper-dim">
            Ferramenta interna — os clientes usam só o construtor com IA.{" "}
            <Link href="/app/templates" className="font-semibold text-brand-2 hover:underline">
              Templates
            </Link>
          </p>
        </div>
